...
my_aop_yr <- '2017'
my_aop_site <- 'BLUE'
my_aq_polygon <- 'BLUE_AOSpts'
my_domain <- 'D11'
# my_water_sf <- st_read(glue('{data_dir}/AOP/site-polygons/PRLA_2016.shp'))


# save_radiance_gpstime('SUGG', '2014', 'OSBS', 'SUGG_AOSpts', 'D03', '/Volumes/hondula/DATA')
# save_radiance_gpstime('BARC', '2014', 'OSBS', 'BARC_AOSpts', 'D03', '/Volumes/hondula/DATA')


save_L1reflectance_spectra('BARC', '2014', 'OSBS', 'BARC_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('BARC', '2016', 'OSBS', 'BARC_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('BARC', '2017', 'OSBS', 'BARC_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('BARC', '2018', 'OSBS', 'BARC_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('BARC', '2019', 'OSBS', 'BARC_AOSpts', 'D03', '/Volumes/hondula/DATA')

save_L1reflectance_spectra('SUGG', '2014', 'OSBS', 'SUGG_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('SUGG', '2016', 'OSBS', 'SUGG_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('SUGG', '2017', 'OSBS', 'SUGG_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('SUGG', '2018', 'OSBS', 'SUGG_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('SUGG', '2019', 'OSBS', 'SUGG_AOSpts', 'D03', '/Volumes/hondula/DATA')

save_L1reflectance_spectra('PRLA', '2016', 'WOOD', 'PRLA_AOSpts', 'D09', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('PRLA', '2017', 'WOOD', 'PRLA_AOSpts', 'D09', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('PRLA', '2019', 'WOOD', 'PRLA_AOSpts', 'D09', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('PRLA', '2020', 'WOOD', 'PRLA_AOSpts', 'D09', '/Volumes/hondula/DATA')

save_L1reflectance_spectra('PRPO', '2016', 'WOOD', 'PRPO_AOSpts', 'D09', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('PRPO', '2017', 'WOOD', 'PRPO_AOSpts', 'D09', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('PRPO', '2019', 'WOOD', 'PRPO_AOSpts', 'D09', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('PRPO', '2020', 'WOOD', 'PRPO_AOSpts', 'D09', '/Volumes/hondula/DATA')

save_L1reflectance_spectra('CRAM', '2016', 'UNDE', 'CRAM_AOSpts', 'D05', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('CRAM', '2017', 'UNDE', 'CRAM_AOSpts', 'D05', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('CRAM', '2019', 'UNDE', 'CRAM_AOSpts', 'D05', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('CRAM', '2020', 'UNDE', 'CRAM_AOSpts', 'D05', '/Volumes/hondula/DATA')

save_L1reflectance_spectra('LIRO', '2017', 'LIRO', 'LIRO_AOSpts', 'D05', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('LIRO', '2020', 'LIRO', 'LIRO_AOSpts', 'D05', '/Volumes/hondula/DATA')

save_L1reflectance_spectra('TOOK', '2017', 'TOOL', 'TOOK_AOSpts', 'D18', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('TOOK', '2018', 'TOOL', 'TOOK_AOSpts', 'D18', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('TOOK', '2019', 'TOOL', 'TOOK_AOSpts', 'D18', '/Volumes/hondula/DATA')

save_L1reflectance_spectra('BLWA', '2015', 'DELA', 'BLWA_AOSpts', 'D08', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('BLWA', '2016', 'DELA', 'BLWA_AOSpts', 'D08', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('BLWA', '2017', 'DELA', 'BLWA_AOSpts', 'D08', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('BLWA', '2018', 'DELA', 'BLWA_AOSpts', 'D08', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('BLWA', '2019', 'DELA', 'BLWA_AOSpts', 'D08', '/Volumes/hondula/DATA')

save_L1reflectance_spectra('FLNT', '2014', 'JERC', 'FLNT_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('FLNT', '2016', 'JERC', 'FLNT_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('FLNT', '2017', 'JERC', 'FLNT_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('FLNT', '2018', 'JERC', 'FLNT_AOSpts', 'D03', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('FLNT', '2019', 'JERC', 'FLNT_AOSpts', 'D03', '/Volumes/hondula/DATA')

save_L1reflectance_spectra('TOMB', '2015', 'LENO', 'TOMB_AOSpts', 'D08', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('TOMB', '2016', 'LENO', 'TOMB_AOSpts', 'D08', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('TOMB', '2017', 'LENO', 'TOMB_AOSpts', 'D08', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('TOMB', '2018', 'LENO', 'TOMB_AOSpts', 'D08', '/Volumes/hondula/DATA')
save_L1reflectance_spectra('TOMB', '2019', 'LENO', 'TOMB_AOSpts', 'D08', '/Volumes/hondula/DATA')

# save_L1reflectance_spectra('BLUE', '2017', 'BLUE', 'BLUE_AOSpts', 'D11', '/Volumes/hondula/DATA')
...
save_L1reflectance_spectra <- function(my_aq_site, my_aop_yr, my_aop_site, 
                                       my_aq_polygon, my_domain, data_dir){
