...
A proportionality factor $Q(\theta, \phi, \lambda)$ in units of [sr] can relate $R_{RS}$ to $R$.
...
![](http://www.gisresources.com/wp-content/uploads/2013/08/isotropy.jpg)
...
* $\zeta$ is the water-to-air divergence factor, ~0.52

* $\Gamma$ accounts for the effects of internal reflection from the water surface, ~1.6
...
$\kappa \approx 1.0546$
$theta'_{sun}$ is sun zenith angle in water
...
Based on idea that residual radiance in NIR (~700 - 1000 nm) 
